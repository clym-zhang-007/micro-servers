# -*- coding: utf-8 -*-
"""保险智能问答助手 - RAG + ES 全文检索 + SQL 查询（基础版本）

版本说明:
    整合 RAG 文档检索、ES 全文检索和 SQL 数据库查询的基础问答助手。

功能特性:
    - 自然语言问答：用户用中文提问，模型结合保险文档进行回答
    - 文档检索 (RAG)：加载 docs/ 目录下的保险文档作为知识库
...
运行方式:
    - 直接运行: python qwen-agent-rag-es-sql-1.py (默认启动 WebUI)
